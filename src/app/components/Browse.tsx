...
const propertyFilters = {
  propertyType: ["Apartment", "Villa", "Townhouse", "Penthouse", "Studio", "Land"],
  bedrooms: ["Studio", "1", "2", "3", "4", "5+"],
  bathrooms: ["1", "2", "3", "4+"],
  furnishing: ["Furnished", "Semi Furnished", "Unfurnished"],
  amenities: ["Balcony", "Pool", "Gym", "Parking", "Security", "Maid's Room"],
};
...
export function Browse({ initial, onBack, onOpen }: Props) {
  ...
  const catTitle = cat === "motors" ? "Motors" : cat === "property" ? "Property" : cat === "classifieds" ? "Classifieds" : t("browse.title");
          ...
          {cat === "property" && (
            <>
              ...
              <Section title="Property Type">
                <PillGroup items={propertyFilters.propertyType} k="propertyType" has={m.has} toggle={m.toggle} viewMore />
              </Section>
              <Section title="Bedrooms">
                <PillGroup items={propertyFilters.bedrooms} k="bedrooms" has={m.has} toggle={m.toggle} />
              </Section>
              <Section title="Bathrooms">
                <PillGroup items={propertyFilters.bathrooms} k="bathrooms" has={m.has} toggle={m.toggle} />
              </Section>
              <Section title="Furnishing">
                <PillGroup items={propertyFilters.furnishing} k="furnishing" has={m.has} toggle={m.toggle} />
              </Section>
              <Section title="Amenities">
                <PillGroup items={propertyFilters.amenities} k="amenities" has={m.has} toggle={m.toggle} viewMore />
              </Section>
            </>
          )}
