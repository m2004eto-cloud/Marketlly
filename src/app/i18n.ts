  ...
  en: {
    translation: {
      ...
      auth: {
        ...
        mobile: "Mobile number", mobilePh: "52 552 6171", countryCode: "Country code",
        signinAs: "Sign in as", create: "Create account", continueVerify: "Continue & verify via WhatsApp",
        sendingOtp: "Sending code…",
        verifyWhatsApp: "Verify your WhatsApp number",
        otpSentTo: "We sent a 6-digit code to",
        otpSentWhatsApp: "Verification code sent to your WhatsApp",
        otpSentOnScreen: "Your verification code is shown on screen",
        otpUseCodeBelow: "Enter the verification code for",
        yourVerificationCode: "Your verification code",
        otpOnScreenHint: "WhatsApp API is not configured — use this code to verify your number.",
        otpSent: "Verification code sent via WhatsApp",
        otpDemoCode: "Demo code: {{code}}",
        otpVerified: "Phone verified successfully",
        otpInvalid: "Invalid code. Please try again.",
        otpExpired: "Code expired. Request a new one.",
        otpIncomplete: "Enter the full 6-digit code",
        otpResendWait: "Please wait before requesting another code",
  ...
  ar: {
    translation: {
      ...
      auth: {
        ...
        mobile: "رقم الجوال", mobilePh: "52 552 6171", countryCode: "رمز الدولة",
        signinAs: "دخول كـ", create: "إنشاء حساب", continueVerify: "متابعة والتحقق عبر واتساب",
        sendingOtp: "جاري إرسال الرمز…",
        verifyWhatsApp: "تحقق من رقم واتساب",
        otpSentTo: "أرسلنا رمزاً من 6 أرقام إلى",
        otpSentWhatsApp: "تم إرسال رمز التحقق إلى واتساب",
        otpSentOnScreen: "رمز التحقق معروض على الشاشة",
        otpUseCodeBelow: "أدخل رمز التحقق لـ",
        yourVerificationCode: "رمز التحقق",
        otpOnScreenHint: "واجهة واتساب غير مفعّلة — استخدم هذا الرمز للتحقق.",
        otpSent: "تم إرسال رمز التحقق عبر واتساب",
        otpDemoCode: "رمز تجريبي: {{code}}",
        otpVerified: "تم التحقق من الرقم بنجاح",
        otpInvalid: "رمز غير صحيح. حاول مرة أخرى.",
        otpExpired: "انتهت صلاحية الرمز. اطلب رمزاً جديداً.",
        otpIncomplete: "أدخل الرمز المكون من 6 أرقام",
        otpResendWait: "يرجى الانتظار قبل طلب رمز جديد",
        verifyAndCreate: "تحقق وأنشئ الحساب",
        verifying: "جاري التحقق…",
        noCode: "لم يصلك الرمز؟",
        resendOtp: "إعادة الإرسال عبر واتساب",
        resendIn: "إعادة الإرسال خلال {{seconds}} ث",
        backToForm: "العودة للتسجيل",
